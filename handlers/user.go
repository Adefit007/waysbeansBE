...
func (h *handlerUser) GetUser(w http.ResponseWriter, r *http.Request) {
	...
	w.WriteHeader(http.StatusOK)
	response := dto.SuccessResult{Code: http.StatusOK,Data: convertUsersResponse(user)}
	json.NewEncoder(w).Encode(response)
}
...
func convertUsersResponse(u models.User) usersdto.UserResponse {
	return usersdto.UserResponse{
		...
		Email:    u.Email,
		Password: u.Password,
		Profile: models.Profile{ID: u.ID,Image: u.Profile.Image,Address: u.Profile.Address,Phone: u.Profile.Phone,UserID: u.Profile.UserID},
	}
}